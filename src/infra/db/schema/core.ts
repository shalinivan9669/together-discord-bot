...
export const guildSettings = pgTable('guild_settings', {
  ...
  horoscopeEnabled: boolean('horoscope_enabled').notNull().default(true),
  horoscopeChannelId: varchar('horoscope_channel_id', { length: 32 }),
  horoscopeEveryDays: integer('horoscope_every_days').notNull().default(4),
  horoscopeNextRunAt: timestamp('horoscope_next_run_at', { withTimezone: true }),
  horoscopeLastPostAt: timestamp('horoscope_last_post_at', { withTimezone: true }),
  horoscopePostMessageId: varchar('horoscope_post_message_id', { length: 32 }),
